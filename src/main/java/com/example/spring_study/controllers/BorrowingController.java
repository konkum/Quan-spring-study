...
public class BorrowingController {
    ...
    @GetMapping(path = "/get")
    public ResponseEntity<BorrowingResponse> getBorrowingById(@Param("id") int id) {
    ...
    public ResponseEntity<Page<BorrowingResponse>> getAllBorrowings(@Valid @ModelAttribute BaseSearchRequest request) {
    ...
    public ResponseEntity<Page<BorrowingResponse>> getBorrowingsSortedBy(@Valid @ModelAttribute BorrowingSortRequest request) {
    ...
    public ResponseEntity deleteBorrowing(@Param("id") int id) {
    ...
    public ResponseEntity<BorrowingResponse> createBorrowing(@Valid @RequestBody BorrowingRequest request) {
    ...
    public ResponseEntity<BorrowingResponse> updateBorrowing(@Param("id") int id, @Valid @RequestBody BorrowingRequest request) {
    ...
    public ResponseEntity<Page<BorrowingResponse>> findByItemName(@Param("itemName") String itemName, @Valid @ModelAttribute BaseSearchRequest pageable) {
    ...
    public ResponseEntity<Page<BorrowingResponse>> findByHandOverDate(@RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDateTime startDate,
    ...
    public ResponseEntity<Page<BorrowingResponse>> findByItemType(@Param("type") Type type, @Valid @ModelAttribute BaseSearchRequest pageable) {
    ...
    public ResponseEntity<Page<BorrowingResponse>> findByTotalPrice(@Param("totalPrice") double totalPrice, @Valid @ModelAttribute BaseSearchRequest pageable) {
    ...
    public ResponseEntity<List<BorrowingResponse>> transferDevice(@Param("borrowingIdFrom") int borrowingIdFrom,
